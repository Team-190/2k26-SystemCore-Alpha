...
public class FuelSimulator {
  ...
  protected Supplier<ChassisVelocities> robotFieldVelocitiesSupplier = null;
  ...
  public void registerRobot(
    ...
    this.robotFieldVelocitiesSupplier = fieldSpeedsSupplier;
   ...
   * @param poseSupplier
   * @param fieldVelocitiesSupplier field-relative `ChassisVelocities` supplier
   */
  public void registerRobot(
      Distance width,
      Distance length,
      ...
      Supplier<Pose2d> poseSupplier,
      Supplier<ChassisVelocities> fieldVelocitiesSupplier) {
    this.robotPoseSupplier = poseSupplier;
    this.robotFieldVelocitiesSupplier = fieldVelocitiesSupplier;
  ...
  public void launchFuel(
    ...
    if (robotPoseSupplier == null || robotFieldVelocitiesSupplier == null) {
    ...
    xVel += fieldVelocities.vx;
    yVel += fieldVelocities.vy;
  ...
  protected void handleRobotCollisions(ArrayList<Fuel> fuels) {
    ...
    ChassisVelocities speeds = robotFieldVelocitiesSupplier.get();
