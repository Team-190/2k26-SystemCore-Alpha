    ...
    public V3_Horse_CV2_TRRobotContainer(){
        if (Constants.getMode() != RobotMode.REPLAY) {
            ...
            case V3_Horse_CV2_TR:
                rollerFloor = new V3_Horse_CV2_TR_RollerFloor(new GenericRollerIOTalonFX(V3_Horse_CV2_TR_RollerFloorConstants.ROLLER_FLOOR_CONSTANTS));
                break;
            case V3_Horse_CV2_TR_SIM:
                rollerFloor = new V3_Horse_CV2_TR_RollerFloor(new GenericRollerIOSim(V3_Horse_CV2_TR_RollerFloorConstants.ROLLER_FLOOR_CONSTANTS));
                break;
            default:
                break;
    }   
